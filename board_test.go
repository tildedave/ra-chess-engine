...
func TestSquareToAlgebraicString(t *testing.T) {
	...
	assert.Equal(t, "a2", SquareToAlgebraicString(22))
	assert.Equal(t, "a3", SquareToAlgebraicString(23))
	assert.Equal(t, "a4", SquareToAlgebraicString(24))
	assert.Equal(t, "a5", SquareToAlgebraicString(25))
	assert.Equal(t, "a6", SquareToAlgebraicString(26))
	assert.Equal(t, "a7", SquareToAlgebraicString(27))
	assert.Equal(t, "a8", SquareToAlgebraicString(28))
	assert.Equal(t, "??", SquareToAlgebraicString(29))
	assert.Equal(t, "??", SquareToAlgebraicString(30))
	assert.Equal(t, "b1", SquareToAlgebraicString(31))
	assert.Equal(t, "c1", SquareToAlgebraicString(41))
	assert.Equal(t, "d1", SquareToAlgebraicString(51))
	assert.Equal(t, "e1", SquareToAlgebraicString(61))
	assert.Equal(t, "f1", SquareToAlgebraicString(71))
	assert.Equal(t, "g1", SquareToAlgebraicString(81))
}
